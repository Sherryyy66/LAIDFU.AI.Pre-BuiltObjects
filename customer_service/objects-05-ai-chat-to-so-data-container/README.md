...
- **v1.0.1** (2026-01-19): 更新安装与配置文档（v1.0.1），补充前置条件。
...
2. 将压缩文件解压至本地文件夹。
3. 参考解压后的“Objects安装与配置文档_AI 对话转销售订单数据载体_v1.0.1.pdf”完成配置。
...
- 版本详细要求可在每个 Objects文件夹的“Objects安装与配置文档_AI 对话转销售订单数据载体_v1.0.1.pdf”文档中找到。
### 3. 环境验证：
